...
//    @FieldOrder({"ext_data", "visualid", "c_class", "red_mask", "green_mask", "blue_mask", "bits_per_rgb",
//		"map_entries"})
...
//	}
	...
	// } XExtData;
    @FieldOrder({"number", "next", "free_private", "private_data"})
    ...
    @FieldOrder({"depth", "nvisuals", "visuals"})
	class Depth extends Structure {
		...
		public Depth(int depth, int nvisuals, Visual visuals) {
			super();
			this.depth = depth;
    ...
    // TODO: define structure
    @FieldOrder({"ext_data", "display", "root", "width", "height", "mwidth", "mheight", "ndepths", "depths",
    ...
    @FieldOrder({"width", "height", "xoffset", "format", "data", "byte_order", "bitmap_unit", "bitmap_bit_order",
	...
	class XImage extends Structure {
		...
		// / <i>native declaration : /usr/include/X11/Xlib.h:483</i>
	    @FieldOrder({"create_image", "destroy_image", "get_pixel", "put_pixel", "sub_image", "add_pixel"})
	 ...
	 */
    @FieldOrder({"ext_data", "depth", "bits_per_pixel", "scanline_pad"})
    ...
    @FieldOrder({"ext_data", "private1", "fd", "private2", "proto_major_version", "proto_minor_version", "vendor",
    ...
    */
    ...
    int XInitThreads();
    XImage XGetImage(Display dpy, Drawable d, int x, int y, int width, int height, long plane_mask, int format);
