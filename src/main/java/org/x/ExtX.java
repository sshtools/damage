...
public interface ExtX extends X11 {
	...
	interface XExt extends Library {
		...
		XImage XShmCreateImage(Display display, 
				...
				int format, String data, XShmSegmentInfo shminfo,
				IntByReference width, IntByReference height);

		boolean XShmGetImage(Display dpy, Drawable drawable, XImage image,
	...
	interface Xdamage extends Library {
		...
		class NotifyEvent extends Structure {
			...
			protected List<?> getFieldOrder() {
				return Arrays.asList("type", "serial", "send_event", "display",
						"drawable", "damage", "level", "more", "timestamp",
						"area", "geometry");
			}
			...
			public static class ByReference extends NotifyEvent implements
					Structure.ByReference {

			};

			public static class ByValue extends NotifyEvent implements
					Structure.ByValue {

			};
		}

		Xdamage INSTANCE = (Xdamage) Native.loadLibrary("Xdamage",
				Xdamage.class);
		 ...
		 *             {@link #XDamageQueryExtension(org.x.Library.Display, java.nio.IntBuffer, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XDamageQueryExtension(org.x.Library.Display, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		int XDamageQueryExtension(Display dpy,
				IntByReference event_base_return,
				IntByReference error_base_return);
		 ...
		 */
		int XDamageQueryExtension(Display dpy, IntBuffer event_base_return,
				IntBuffer error_base_return);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XDamageQueryVersion(org.x.Library.Display, java.nio.IntBuffer, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XDamageQueryVersion(org.x.Library.Display, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		int XDamageQueryVersion(Display dpy,
				IntByReference major_version_return,
				IntByReference minor_version_return);
		 ...
		 */
		int XDamageQueryVersion(Display dpy, IntBuffer major_version_return,
				IntBuffer minor_version_return);
		 ...
		 */
		void XDamageSubtract(Display dpy, NativeLong damage, NativeLong repair,
				NativeLong parts);
	...
	interface XFixes extends Library {
		...
		public class SelectionNotifyEvent extends Structure {
			...
			protected List<?> getFieldOrder() {
				return Arrays.asList("type", "serial", "send_event", "display",
						"window", "subtype", "owner", "selection", "timestamp",
						"selection_timestamp");
			}
			...
			public static class ByValue extends SelectionNotifyEvent implements
					Structure.ByValue {
		...
		public class BarrierNotifyEvent extends Structure {
			...
			protected List<?> getFieldOrder() {
				return Arrays.asList("type", "serial", "send_event", "display",
						"window", "subtype", "event_id", "directions",
			...
			public static class ByReference extends BarrierNotifyEvent
					implements Structure.ByReference {

			};

			public static class ByValue extends BarrierNotifyEvent implements
					Structure.ByValue {
		...
		class CursorNotifyEvent extends Structure {
			...
			protected List<?> getFieldOrder() {
				return Arrays.asList("type", "serial", "send_event", "display",
						"window", "subtype", "cursor_serial", "timestamp",
						"cursor_name");
			}
			 ...
			 *            C type : Atom
			 */
			public CursorNotifyEvent(int type, NativeLong serial,
					int send_event, Display display, NativeLong window,
					int subtype, NativeLong cursor_serial,
					NativeLong timestamp, NativeLong cursor_name) {
				super();
				this.type = type;
				this.serial = serial;
			...
			public static class ByReference extends CursorNotifyEvent implements
					Structure.ByReference {

			};

			public static class ByValue extends CursorNotifyEvent implements
					Structure.ByValue {
		...
		public class XFixesCursorImage extends Structure {
			...
			protected List<?> getFieldOrder() {
				return Arrays.asList("x", "y", "width", "height", "xhot",
						"yhot", "cursor_serial", "pixels", "atom", "name");
			}
			...
			// }
			public static class ByReference extends XFixesCursorImage implements
					Structure.ByReference {

			};

			public static class ByValue extends XFixesCursorImage implements
					Structure.ByValue {
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesQueryExtension(org.x.Library.Display, java.nio.IntBuffer, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XFixesQueryExtension(org.x.Library.Display, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		int XFixesQueryExtension(Display dpy, IntByReference event_base_return,
				IntByReference error_base_return);
		 ...
		 */
		int XFixesQueryExtension(Display dpy, IntBuffer event_base_return,
				IntBuffer error_base_return);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesQueryVersion(org.x.Library.Display, java.nio.IntBuffer, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XFixesQueryVersion(org.x.Library.Display, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		 ...
		 */
		int XFixesQueryVersion(Display dpy, IntBuffer major_version_return,
				IntBuffer minor_version_return);
		 ...
		 */
		void XFixesChangeSaveSet(Display dpy, NativeLong win, int mode,
				int target, int map);
		 ...
		 */
		void XFixesSelectSelectionInput(Display dpy, NativeLong win,
				NativeLong selection, NativeLong eventMask);
		 ...
		 */
		void XFixesSelectCursorInput(Display dpy, NativeLong win,
		 ...
		 */
		NativeLong XFixesCreateRegion(Display dpy, XRectangle rectangles,
				int nrectangles);
		 ...
		 */
		NativeLong XFixesCreateRegionFromWindow(Display dpy, NativeLong window,
				int kind);
		 ...
		 */
		void XFixesSetRegion(Display dpy, NativeLong region,
		 ...
		 */
		void XFixesUnionRegion(Display dpy, NativeLong dst, NativeLong src1,
				NativeLong src2);
		 ...
		 */
		void XFixesIntersectRegion(Display dpy, NativeLong dst,
				NativeLong src1, NativeLong src2);
		 ...
		 */
		void XFixesSubtractRegion(Display dpy, NativeLong dst, NativeLong src1,
				NativeLong src2);
		 ...
		 */
		void XFixesInvertRegion(Display dpy, NativeLong dst, XRectangle rect,
				NativeLong src);
		 ...
		 */
		void XFixesTranslateRegion(Display dpy, NativeLong region, int dx,
				int dy);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesFetchRegion(org.x.Library.Display, com.sun.jna.NativeLong, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XFixesFetchRegion(org.x.Library.Display, com.sun.jna.NativeLong, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		XRectangle XFixesFetchRegion(Display dpy, NativeLong region,
				IntByReference nrectanglesRet);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesFetchRegionAndBounds(org.x.Library.Display, com.sun.jna.NativeLong, java.nio.IntBuffer, org.x.x11.XRectangle)}
		 *             and
		 *             {@link #XFixesFetchRegionAndBounds(org.x.Library.Display, com.sun.jna.NativeLong, com.sun.jna.ptr.IntByReference, org.x.x11.XRectangle)}
		 *             instead
		 */
		@Deprecated
		XRectangle XFixesFetchRegionAndBounds(Display dpy, NativeLong region,
				IntByReference nrectanglesRet, XRectangle bounds);
		 ...
		 */
		XRectangle XFixesFetchRegionAndBounds(Display dpy, NativeLong region,
				IntBuffer nrectanglesRet, XRectangle bounds);
		 ...
		 */
		void XFixesSetGCClipRegion(Display dpy, GC gc, int clip_x_origin,
				int clip_y_origin, NativeLong region);
		 ...
		 */
		void XFixesSetWindowShapeRegion(Display dpy, NativeLong win,
				int shape_kind, int x_off, int y_off, NativeLong region);
		 ...
		 */
		void XFixesSetPictureClipRegion(Display dpy, NativeLong picture,
				int clip_x_origin, int clip_y_origin, NativeLong region);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesSetCursorName(org.x.Library.Display, com.sun.jna.NativeLong, java.lang.String)}
		 *             and
		 *             {@link #XFixesSetCursorName(org.x.Library.Display, com.sun.jna.NativeLong, com.sun.jna.Pointer)}
		 *             instead
		 */
		@Deprecated
		 ...
		 */
		String XFixesGetCursorName(Display dpy, NativeLong cursor,
				NativeLongByReference atom);
		 ...
		 */
		void XFixesChangeCursor(Display dpy, NativeLong source,
				NativeLong destination);
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesChangeCursorByName(org.x.Library.Display, com.sun.jna.NativeLong, java.lang.String)}
		 *             and
		 *             {@link #XFixesChangeCursorByName(org.x.Library.Display, com.sun.jna.NativeLong, com.sun.jna.Pointer)}
		 *             instead
		 */
		@Deprecated
		void XFixesChangeCursorByName(Display dpy, NativeLong source,
				Pointer name);
		 ...
		 */
		void XFixesExpandRegion(Display dpy, NativeLong dst, NativeLong src,
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesCreatePointerBarrier(org.x.Library.Display, com.sun.jna.NativeLong, int, int, int, int, int, int, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XFixesCreatePointerBarrier(org.x.Library.Display, com.sun.jna.NativeLong, int, int, int, int, int, int, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		NativeLong XFixesCreatePointerBarrier(Display dpy, NativeLong w,
		 ...
		 * 
		 * @deprecated use the safer methods
		 *             {@link #XFixesCreatePointerBarrierVelocity(org.x.Library.Display, com.sun.jna.NativeLong, int, int, int, int, int, int, int, java.nio.IntBuffer)}
		 *             and
		 *             {@link #XFixesCreatePointerBarrierVelocity(org.x.Library.Display, com.sun.jna.NativeLong, int, int, int, int, int, int, int, com.sun.jna.ptr.IntByReference)}
		 *             instead
		 */
		@Deprecated
		NativeLong XFixesCreatePointerBarrierVelocity(Display dpy,
				NativeLong w, int x1, int y1, int x2, int y2, int directions,
		 ...
		 */
		void XFixesSelectBarrierInput(Display dpy, NativeLong win,
				NativeLong eventMask);
	...
	int XGetErrorDatabaseText(Display display, String name, String message,
			String default_string, ByteBuffer buffer_return, int length);
